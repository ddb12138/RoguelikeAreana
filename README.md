...
这是基于 Godot 4.3 / GDScript 的俯视角 2D 生存动作游戏，入口为 `sences/ui/main_menu.tscn`。

- [AI 协作指南](AGENTS.md)：项目约定与修改注意事项。
- [项目知识地图](docs/ARCHITECTURE.md)：目录职责、场景装配、战斗和成长链路。
- [开发与验证基线](docs/DEVELOPMENT.md)：启动方式、隔离存档、已知问题和回归范围。
